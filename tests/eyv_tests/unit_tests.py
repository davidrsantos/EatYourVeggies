...
from eyv_rest_api import transaction_creation
...
class EatYourVeggiesTest(unittest.TestCase):

    @classmethod
    def setUpClass(cls):
        wait_for_rest_apis([REST_URL])
        cls.client = EatYourVeggiesClient(REST_URL)
...
class EatYourVeggiesClient(object):
