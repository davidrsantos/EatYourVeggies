    ...
    <v-container>
                    ...
                    <v-row>
                                ...
                                <v-container>
                                    ...
                                    <v-card-text>
                                        <v-row>
                                            ...
                                            <v-toolbar color="green" dark dense>
                                                <v-toolbar-title
                                                    >Classification</v-toolbar-title
                                                >
                                                <v-spacer></v-spacer>
                                                <v-btn
                                                    @click="
                        ...
                        <v-col cols="6">
                            <v-card>
                                <v-container>
                                    <v-card-title
                                        >Product Properties</v-card-title
                                    >
                                    <v-card-text>
                                        <v-toolbar color="green" dark dense>
                                            <v-toolbar-title
                                                >Temperature ºC</v-toolbar-title
                                            >
                                            <v-spacer></v-spacer>
                                            <v-btn
                                                @click="
            ...
            <v-card>
                <v-container>
                    <v-card-title class="headline"
                        >Insert {{ dialogLabel }}:</v-card-title
                    >
                    <v-menu
        ...
        <v-dialog max-width="600" v-model="dialogLocalization">
            <v-card>
                <v-container>
                    <v-card-title class="headline"
                        >Insert Localization:</v-card-title
                    >
                    <v-text-field
                        :error-messages="doublePropsErrors"
