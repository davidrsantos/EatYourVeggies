...
export default {
    ...
    methods: {
        changeStatus(user) {
            ...
            return axios
                .patch('users/' + user.publicKey, statusUpdate)
                .then(response => {
                    this.getUser();
                })
                .catch(error => {
                    ...
                    if (error.response && error.response.data.errors) {
                        ...
                        this.errors = [
                            'Problem connecting server or unknown error'
                        ];
        ...
        getUser() {
            axios
                .get(`agents/${this.$route.params.publicKey}`)
                .then(res => {
                    this.user = res.data;
                })
                .catch(error => {
