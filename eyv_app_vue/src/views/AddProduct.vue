        ...
        <v-container>
            <form>
                ...
                <v-row justify="center">
                    <v-btn
                        :disabled="
                            submitStatus === 'ERROR' || file.size > 2000000
                        "
                        @click="submit"
                        class="mr-4"
                        >submit
    ...
    computed: {
        batchErrors() {
            ...
            !this.$v.batch.maxLength &&
                errors.push(
                    'The batch should not be more that 50 characters long'
                );
            !this.$v.batch.minLength &&
                errors.push('The batch must be at most 1 characters long');
        ...
        cultivationProcessErrors() {
            ...
            !this.$v.cultivationProcess.maxLength &&
                errors.push(
                    'The Cultivation Process should not be more that 50 characters long'
                );
            !this.$v.cultivationProcess.minLength &&
                errors.push(
                    'The Cultivation Process must be at most 1 characters long'
                );
            !this.$v.cultivationProcess.required &&
                errors.push('Cultivation Process is required.');
        ...
        latitudeErrors() {
            ...
            !this.$v.latitude.minLength &&
                errors.push('The latitude must be at most 1 characters long');
        ...
        longitudeErrors() {
            ...
            !this.$v.longitude.required &&
                errors.push('Longitude is required.');
            !this.$v.longitude.minLength &&
                errors.push('The longitude must be at most 1 characters long');
        ...
        addProduct() {
            let recordPayload = payloads.createRecord({
                ...
                properties: [
                    ...
                    },
                    {
                        name: 'harvestDate',
                        timestampValue:
                            new Date(this.harvestDate).getTime() / 1000,
                    ...
                    },
                    {
                        ...
                        timestampValue:
                            this.expirationDate !== null
                                ? new Date(this.expirationDate).getTime() / 1000
                                : null,
                        dataType: payloads.createRecord.enum.TIMESTAMP
                    },
                    {
                        ...
                        timestampValue:
                            this.expirationDate !== null
                                ? new Date(this.packingDate).getTime() / 1000
                                : null,
                        dataType: payloads.createRecord.enum.TIMESTAMP
                    },
                    {
            ...
            if (
                ...
                new Date(this.expirationDate).getTime() <
                    new Date(this.harvestDate).getTime()
            ) {
                this.$emit(
                    'errorEvent',
                ...
                this.packingDate < this.harvestDate
            ) {
                this.$emit(
                    'errorEvent',
                ...
                this.expirationDate !== null &&
                this.packingDate !== null &&
                this.packingDate < this.expirationDate
            ) {
                this.$emit(
                    'errorEvent',
                ...
                this.$snotify.async(
                    ...
                    () => {
                        return new Promise((resolve, reject) => {
                            return transactions
                                .submit([recordPayload], true)
                                .then(response => {
                                    const formData = new FormData();
                                    formData.append('file', this.file);
                                    axios
                                        .post('upload/' + this.batch, formData)
                                        .catch(err => {
                                            throw err;
                                        });
                                    if (
                                        ...
                                        setTimeout(
                                            () =>
                                                resolve({
                                                    title: 'Success',
                                                    body:
                                                        'Successfully submitted product',
                                                    config: {
