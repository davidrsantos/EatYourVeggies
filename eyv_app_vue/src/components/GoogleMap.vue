<template>
    <v-container>
        <v-row>
            <v-col align="center">
                <v-toolbar dense height="80" width="500">
                    <label>
                        <gmap-autocomplete
    ...
    computed: {
        LatErrors() {
            ...
            !this.$v.latitude.maxLength &&
                errors.push(
                    'The latitude should not be more that 10 characters long'
                );
        ...
        LngErrors() {
            ...
            !this.$v.longitude.maxLength &&
                errors.push(
                    'The longitude should not be more that 10 characters long'
                );
    ...
    methods: {
        ...
        reportLocalization() {
            this.updateProperty(this.record, {
                name: 'location',
                locationValue: {
                    latitude: parsing.toInt(
                        this.currentPlace.geometry.location.lat()
                    ),
                    longitude: parsing.toInt(
