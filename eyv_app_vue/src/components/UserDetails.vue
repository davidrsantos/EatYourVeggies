        ...
        <v-card class="mx-auto mt-5" max-width="1000">
            ...
            <v-container>
                <form>
                    ...
                    <v-text-field
                        @click:append="
                            openDialog(user.email, 'email', 'E-mail')
                        "
                    ...
                    <v-text-field
                        @click:append="
                            openDialog(user.username, 'username', 'Username')
                        "
                        append-icon="mdi-pencil"
                        label="Username"
                        outlined
                ...
                <div class="text-center">
                    <v-dialog v-model="dialogPassword" width="600">
...
export default {
    ...
    methods: {
        ...
        userUpdate() {
            ...
            return axios
                .patch('users/' + this.user.publicKey, userUpdate)
                .then(response => {
                    let user = response.data;
                    user.name = this.user.name;
                    this.user = user;
